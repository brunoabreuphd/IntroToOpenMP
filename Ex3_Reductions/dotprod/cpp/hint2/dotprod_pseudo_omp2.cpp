/***
 * File: dotprod_pseudo_omp2.cpp
 * Description: Hints to parallelize Dot Product with OpenMP
 * Author: Bruno R. de Abreu  |  babreu at illinois dot edu
 * National Center for Supercomputing Applications (NCSA)
 *
 * Creation Date: Tuesday, 25th January 2022, 3:12:21 pm
 * Last Modified: Tuesday, 25th January 2022, 3:12:24 pm
 *
...
int main()
{
    ...
    // !! HINT2 use a reduction clause (sum) in the loop directive !!
    for (i = 0; i < ORD; i++)
    {
        dotp = dotp + v1[i] * v2[i];
    }
