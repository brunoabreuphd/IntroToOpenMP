!!!!
!! File: saxpy_pseudo_omp2.f90
!! Description: SAXPY simple implementation with hints to include OpenMP directives
!! Author: Bruno R. de Abreu  |  babreu at illinois dot edu
!! National Center for Supercomputing Applications (NCSA)
!!  
!! Creation Date: Thursday, 20th January 2022, 10:08:46 am
!! Last Modified: Thursday, 20th January 2022, 10:10:51 am
!!  
...
program saxpy_hints
    ...
    ! ## HINT1 open omp do directive here ## choose loop scheduling here ##
    ! ## HINT2 add the scheduling option along with the omp do directive ##
    do i = 1, ORD
        y(i) = a*x(i) + y(i)
    enddo
