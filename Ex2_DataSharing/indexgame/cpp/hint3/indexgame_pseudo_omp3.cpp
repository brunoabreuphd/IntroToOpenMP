/***
 * File: indexgame_pseudo_omp3.cpp
 * Description: Hints to parallelize Index Game with OpenMP
 * Author: Bruno R. de Abreu  |  babreu at illinois dot edu
 * National Center for Supercomputing Applications (NCSA)
 *
 * Creation Date: Monday, 24th January 2022, 2:20:08 pm
 * Last Modified: Monday, 24th January 2022, 2:20:11 pm
 *
...
int main()
{
    ...
    // !! HINT3 declare another matrix to hold the shuffled values -- the helper
    vector<double> v; // vector
    // !! HINT3 declare a vector that hosts only zeros
