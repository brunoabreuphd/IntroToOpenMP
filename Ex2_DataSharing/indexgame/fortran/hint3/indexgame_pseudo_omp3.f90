!!!!
!! File: indexgame_pseudo_omp3.f90
!! Description: Hints to parallelize Index Game with OpenMP
!! Author: Bruno R. de Abreu  |  babreu at illinois dot edu
!! National Center for Supercomputing Applications (NCSA)
!!  
!! Creation Date: Tuesday, 25th January 2022, 10:43:07 am
!! Last Modified: Tuesday, 25th January 2022, 10:46:49 am
!!  
...
program indexgame_hints
    ...
    ! ## HINT3 declare another matrix that will hold the shuffled values ##
    ...
    ! allocate matrix
    allocate(M(ORD,ORD))
    ! ## HINT3 allocate the helper matrix ##

    ! initialize random number generator, fill matrix
    call random_seed()
    call random_number(M)
    ! ## HINT3 give the helper matrix zeros ##
    ...
    ! ## HINT2 declare explicitly which variables are shared, which are private ##
    ...
    do j = 1, ORD
        do i = 1, ORD
            ...
            ! ## HINT3 instead of copying it to M itself, use the helper matrix ##
        enddo
    enddo
    ...
    ! print output
    ! ## HINT3 remember to print the elements of the helper, not M's ##
    write(*,*)
    ...
    ! ## HINT2 choose a couple of values i,j, then perform the 
    !          transformation into shuff_i, shuff_j by hand
    !           and check if it matches ##

    ! cleanup and bye
    deallocate(M)
    ! ## HINT3 clean up the helper as well before you go ##                        
